            ...
            : <div className="flex flex-col space-y-8 m-8">
              {
                this.state.quotesdata.map(
                  ...
                  <div className="grid gap-y-2 border-4 rounded-xl border-primary p-4" key={i}>
                    ...
                    <button className="square-btn flex flex-row gap-2" onClick={() => this.openEditModal(quote)}>
                    ...
                    <button className="square-btn flex flex-row gap-2" onClick={() => this.openDeleteModal(quote)}>
